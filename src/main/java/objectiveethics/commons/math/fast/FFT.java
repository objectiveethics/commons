...
import objectiveethics.commons.primitive.Complex;
...
public class FFT {
    ...
    public static Complex[] fft(String x) {
    ...
    public static Complex[] ifft(byte[] x) {
        return ifft(toComplex(x));
    }

    public static Complex[] ifft(int[] x) {
        return ifft(toComplex(x));
    }
    ...
    public static Complex[] ifft(String x) {
        return ifft(toComplex(x));
    }
    ...
    public static Complex[] toComplex(String x) {
        Complex[] c = new Complex[x.length()];
        for (int i = 0; i < x.length(); i++) {
            c[i] = new Complex(x.charAt(i));
        }
        return c;
    }
    
    public static Complex[] toComplex(byte[] x) {
        Complex[] c = new Complex[x.length];
        for (int i = 0; i < x.length; i++) {
            c[i] = new Complex(x[i]);
        }
    ...
    public static Complex[] toComplex(int[] x) {
        Complex[] c = new Complex[x.length];
        for (int i = 0; i < x.length; i++) {
            c[i] = new Complex(x[i]);
        }
